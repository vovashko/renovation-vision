...
export function StageRoomFields({ prefix, stages, rooms, stageId, roomId, onStage, onRoom }: { prefix: string; stages: Stage[]; rooms: Room[]; stageId: string; roomId: string; onStage: (v: string) => void; onRoom: (v: string) => void }) {
  return (
...
export function UploadSheet({ projectId, open, onOpenChange, stages, rooms }: { projectId: string; open: boolean; onOpenChange: (v: boolean) => void; stages: Stage[]; rooms: Room[] }) {
