...
export function StageTimelineRow({
  ...
  return (
    <Wrapper
      onClick={onClick}
      className="block w-full rounded-xl border bg-card p-4 text-left shadow-[var(--shadow-soft)] focus-visible:ring-2 focus-visible:ring-ring focus-visible:outline-none enabled:hover:border-primary/50"
    >
